           ...
           <div class="row">
                        ...
                        <div class="wizard-inner">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="active">
                                    <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" title="Maquina">
                                ...
                                <li role="presentation" class="disabled">
                                    <a href="#step2" data-toggle="tab" aria-controls="step2" role="tab" title="Reporte">
                                        <span class="round-tab">
                  ...
                  <div class="x_content">
                    ...
                    <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
                      ...
                      <div class="form-group" hidden>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="id_maquina"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>                       
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="no_orden" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cavidades">Caviades: <span class="required">:</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <!-- /form input mask -->
                    ...
                    <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="piezasScrap">Piezas Scrap <span class="required">:</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <button  id="piezasScrap" name="piezasScrap" required="required" class="form-control col-md-7 col-xs-12" onclick="scrapModal()">0</button>
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tiempoMuerto">Tiempo Muerto <span class="required">:</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <button  id="tiempoMuerto" name="tiempoMuerto" required="required" class="form-control col-md-7 col-xs-12" onclick="tiempoModal()">0</button>
                        </div>
                      </div> 
                      <div class="ln_solid"></div>
                      <div class="form-group">
